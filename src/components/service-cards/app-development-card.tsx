...
const benefitIcons: Record<string, JSX.Element> = {
    mobile: <FaMobileAlt className="text-blue-600 text-xl" />,
    ...
    cogs: <FaCogs className="text-purple-600 text-xl" />,
    ...
    return (
        <div className="flex flex-col items-center w-full gap-6 p-6 h-full">
            ...
            <div className="flex flex-col items-center gap-4 text-center">
                <p className="text-gray-600">{t("whyChooseMe")}</p>
            </div>
                ...
                <ul className="space-y-4">
                    {benefits.map((benefit, index) => (
                        <li key={index} className="flex items-start gap-4">
                            <div
                                className={`flex items-center justify-center w-8 h-8 rounded-full shadow-md ${benefit.iconBg}`}
                            >
