    ...
    <section className="w-full space-y-8">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative group">
          ...
          <Card className="w-full bg-turquoise-800/50 backdrop-blur border border-turquoise-600/30 rounded-2xl shadow-sm hover:shadow-md overflow-hidden transition-all">
