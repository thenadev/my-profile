...
export default function Landing() {
    return (
        <div className="items-center h-screen" id="landing">
            <section
                className="grid grid-cols-1 md:grid-cols-2 bg-white dark:bg-gray-900 h-full items-center"
            >
                <div className="pl-10 pr-10 pt-16">
                    <img
                        src={MyAvatar}
                        className="rounded-full w-70 h-auto shadow-lg animate-fadeIn"
                        alt="Avatar"
                    />
                </div>
                <div className="animate-slideIn">
                    <div
                        className="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16"
                    >
                        <div className="place-self-center mr-auto lg:col-span-7">
                            <h1
                                className="mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white"
                            >
                            ...
                            <p
                                className="mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400"
                            >
                                TypeScript, Angular, React and Flutter
                            </p>
