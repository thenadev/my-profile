...
export default function UnternehmenswebsiteFinalCTA({
  ...
  return (
    <div className="w-full max-w-4xl text-center space-y-6 bg-turquoise-800/90 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-turquoise-600/30">
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 mt-6 text-sm text-gray-200">
        <div className="flex items-center gap-2">
          <Award className="h-4 w-4 text-turquoise-500" />
        ...
        <div className="flex items-center gap-2">
          <Zap className="h-4 w-4 text-turquoise-600" />
