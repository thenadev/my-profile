...
interface StartupBeratungHeroProps {
  onTerminClick: () => void;
}
...
export default function StartupBeratungHero({
  ...
  return (
    <motion.section
      ref={heroRef}
      className="relative w-full min-h-[70vh] md:min-h-[75vh] flex items-center bg-background overflow-hidden"
    >
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--hero-portrait-bg-mid)]/30 via-[var(--hero-portrait-bg-dark)]/20 to-[var(--hero-portrait-bg-dark)]/30" />
      </div>

      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 pt-28 pb-16 md:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="text-center lg:text-left space-y-4 lg:space-y-6 flex flex-col">
            <motion.div
              ref={badgeRef}
            ...
            <motion.div
              className="flex flex-wrap justify-center lg:justify-start items-center gap-2 md:gap-4 pt-2"
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <Image
                        ...
                        alt="Thomas Schwabauer – Startup-Beratung"
                        width={500}
                        height={700}
