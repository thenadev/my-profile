...
const QUICK_NAV_ITEMS = [
  {
    id: "preise",
    label: "Preise & Pakete",
    description: "Beratung 80€/h, MVP, Feature/Bug",
    icon: Euro,
  },
  {
    id: "ablauf",
    label: "Ablauf",
    description: "So läuft’s in 3 Schritten",
    icon: ListOrdered,
  },
  {
    id: "termin-formular",
    label: "Termin buchen",
    description: "Anliegen angeben und Beratungstermin vereinbaren",
    icon: Calendar,
  },
  {
    id: "faq",
    label: "Häufige Fragen",
    description: "Flutter, Ablauf, Kosten, MVP",
    icon: HelpCircle,
  },
] as const;
...
export default function AppEntwicklungQuickNav() {
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-10">
        ...
        >
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
            Springen Sie zu Preisen, Ablauf, Terminbuchung oder FAQ.
          </p>
        </motion.div>
