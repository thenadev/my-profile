...
import TechStackOrbs from "./TechStackOrbs";
...
const HomeHero: React.FC = () => {
  ...
  return (
    <div
      className="pt-16 min-h-[100svh] flex items-center justify-center"
      id="home"
    >
      <section className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-center md:justify-between py-6 sm:py-8 md:py-10 px-4 sm:px-6 md:px-10 gap-6 md:gap-8 lg:gap-12">
        {/* Left side with orbs */}
        ...
        <div className="flex flex-col items-center md:items-start justify-center text-center md:text-left p-4 sm:p-6 md:p-10 text-black animate-slideIn w-full md:w-1/2 max-w-lg lg:max-w-md xl:max-w-xl">
          ...
          <p className="mb-4 sm:mb-6 text-sm sm:text-base md:text-lg text-gray-600 max-w-md">
            Ich baue performante Web- und Mobile-Anwendungen mit modernen
            Technologien.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-3 sm:gap-4 w-full sm:w-auto mb-4 sm:mb-6">
            <button
              ...
              aria-label="Projekt starten per Kontaktformular - Antwort innerhalb von 24h"
            >
            ...
            <Link
              ...
              aria-label="Lebenslauf und Dokumente anzeigen - PDF Download verfügbar"
            >
              <FaCalculator className="text-lg sm:text-xl" aria-hidden="true" />
              Lebenslauf
            </Link>
          </div>
          ...
          <small className="text-xs text-gray-500 mb-3 sm:mb-4 text-center md:text-left">
            Direkt anfragen oder CV ansehen • Antwort innerhalb von 24h
          </small>
          ...
          <div className="flex items-center justify-center md:justify-start">
            ...
            <a
              ...
              aria-label="Standort: Wetzlar, Deutschland - In Google Maps öffnen"
            >
              Wetzlar, Deutschland
            </a>
          </div>
        ...
        <div className="flex justify-center md:justify-end p-3 sm:p-4 md:p-6 w-full md:w-1/2 mt-4 sm:mt-6 md:-ml-4">
          <div className="relative group">
            <Image
              ...
              alt="Portrait von Thomas Schwabauer - Fullstack Developer"
              width={600}
              height={600}
              style={{
