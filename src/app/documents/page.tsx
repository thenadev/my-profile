...
const DocumentsPage: React.FC = () => {
    ...
    return (
        <div
            className="flex flex-col items-center z-20 relative px-0 md:px-2 py-28"
            id="documents"
        >
            <h2 className="flex flex-row items-center justify-center gap-2 text-2xl sm:text-3xl font-bold mb-6 text-center">
                {t("title")}
            </h2>
